...
An diese Fragen anknüpfend habe ich einen **Testplan mit zehn Testszenarien und Aufgaben** ausgearbeitet. Parallel dazu habe ich ein **Miro-Board** angelegt, indem ich ausführlicher die möglichen Optionen berücksichtigte, die bei der Bearbeitung zur Auswahl standen. Den in Word formulierten Testplan nutzte ich für Aufzeichnungen während des Usability Tests. Das Miro-Board habe ich dann bei der Auswertung der Aufzeichnungen und meiner Mitschriften eingesetzt. 

Aufgrund der **Corona-Beschränkungen** und dem damit verbundenen Ziel der Kontaktreduzierungen wurde der Usability Test **remote** durchgeführt. Hierfür wurde das **Konferenzsystem Zoom** genutzt, das die Möglichkeit des Teilens des Bildschirms und der Aufzeichnung des Tests zur späteren Auswertung anbietet. Die Tester:innen bekamen jeweils kurz vor Beginn die **Aufgaben per E-Mail** von mir zugeschickt.

{% include gallery id="gallery_testing02" caption="Details des Miro-Boards und Aufgaben für die TesterInnen" %}

Der **Testablauf** sah zum Beginn jedes Tests eine kurze **Einführung** vor, in der ich den Ablauf des Tests erklärt und das Einverständnis zur Aufzeichnung eingeholt habe. Die TesterInnen arbeiteten die Aufgaben immer in derselben Reihenfolge durch. **Fragen oder Hilfestellungen** habe ich während des Tests nicht gegeben, aber die UserInnen manchmal darauf hingeweisen, dass sie mit der nächsten Aufgabe weitermachen können, wenn sie selbst in dem Moment nicht daran gedacht haben. Die TesterInnen nutzten für den Usability Test ihren eigenen Laptop. 

Am **Ende** der habe ich zunächst - wenn nötig - noch **Fragen zu einzelnen Aufgaben** gestellt, um zum Beispiel die Reaktionen oder das Vorgehen der UserInnen besser zu verstehen. Zum Abschluss habe ich allen TesterInnen noch zwei Fragen gestellt, die ihren **persönlichen Eindruck zum Onlineshop** erfassen sollten. Die TeilnehmerInnen habe ich hierfür gefragt, was sie bei einem Relaunch der Webseite verändern und welche Funktionen sie unbedingt beibehalten würden. **Insgesamt dauerten die Tests zwischen 30 und 75 Minuten.**

**Reflektion:** Einen Webshop für dieses Praxisprojekt zu nutzen, den ich bereits gut kannte, hat mir sehr bei der Ausarbeitung des Testplans und der Aufgaben geholfen. Die **Formulierung einiger Aufgaben** hätte noch verbessert werden können, da sie manchmal für die TesterInnen etwas schwerer zu verstehen waren. Auch hatte ich den **Schwierigkeitsgrad der Einstiegsaufgabe** falsch eingeschätzt. Ziel dieser Aufgabe war es **winterharte Sukkulenten** zu suchen. Da es auf der Startseite einen prominent platzierten **Banner** zu dieser Kategorie gab, dachte ich, dass dies eine leicht zu lösende Aufgabe für die TesterInnen darstellt. Der Banner wurde jedoch von allen TesterInnen konsequent ignoriert und der Großteil brauchte zwei oder drei Versuche bis sie die Kategorie "winterharte Pflanzen" auf der Webseite fanden. **Fehlendes Wissen** der TeilnehmerInnen zum Thema Überwinterung von Sukkulenten, welches durch die Webseite nicht bereitgestellt wurde und welches ich nicht bedacht hatte, spielte hierbei auch eine Rolle.
{: .notice--primary}
