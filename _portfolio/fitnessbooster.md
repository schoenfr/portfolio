...
* Die **Bewertung des Sport-Angebots** nach Abschluss des Trainings sollte gegeben sein, um die persönlichen Präferenzen und damit die Auswahl des Angebots zu verbessern.
* Die **Kommunikation** mit anderen Personen, um gemeinsam Sport zu machen, gehörte ebenfalls dazu.

In den Storyboards wurde sich auf Nutzer:innen-Szenarien konzentriert, die bereits annahmen, dass diese **die App nicht zum ersten Mal** nutzten. Für das Minimum Viable Product wurde deswegen der **Anmeldungs- bzw. Registrierungsprozess** und die **Einschätzung des Users** zum eigenen Fitness-Level und zu bisherigen Sport-Erfahrungen ausgeklammert. Außerdem wurde sich für den ersten Entwurf auf das digitale Angebot fokussiert.

{% include gallery id="gallery_paperprototype01" caption="Paper Prototype: Gesamtansicht mit Screens für beide Storyboards" %}

Als nächstes wurde der **Paper Prototype** umgesetzt, mit dem **die Abläufe in den Storyboards** geprüft werden sollten. Hierfür habe ich nach meinem eigenen Smartphone eine Schablone gebastelt und die Größe der einzelnen Papier-Screens entsprechend angepasst. Dann habe ich die einzelnen Schritte des ersten Storyboards visualisiert und anschließend die Interaktionen zwischen User:in und App im zweiten Storyboard verglichen, welche Screens weiterhin funktionierten und welche neu hinzukommen mussten. Welche Inhalte in den einzelnden Screens klickbar waren und welche nicht, habe ich durch einen Schatten angedeutet.
...
* **Flexibilität**: Verschiedene Geräte wie Laptop, Tablet oder Fernseher für das Workout nutzen zu können, ist durch den Prototyp bisher nicht gegeben und sollte ermöglicht werden. Responsive Design wäre in diesem Zusammenhang ein wichtiger Punkt.
...
* Offen war, nach welchen **Präferenzen** die Sport-Angebote individuell zusammengestellt werden sollten.
