...
Welche Funktionalitäten musste die App zwingend besitzen? Und welche Bestandteile konnten auch später noch eingefügt werden? Das waren die beiden Fragen, die mich beschäftigten und die ich durch **Storyboards** zu lösen suchte. Das Konzept der Storyboards bot mir einerseits die Möglichkeit nah am an der Zielgruppe und ihren Bedürfnissen zu bleiben und andererseits einen guten Ausgangspunkt, um über die typische Nutzung meiner App im Alltag zu reflektieren und das MVP zu definieren. Es wurden **zwei Storyboards** erstellt; für jede Persona eins. 
...
Im **ersten Storyboard** wurde auch die Pandemie-bedingte Home Office-Situation vieler Menschen berücksichtigt und der **Fokus auf das Auspobieren eines neuen Trainings** gelegt. Im Anschluss an das Training wurde zudem eine **Bewertung des Angebots** eingeplant. Im Storyboard wurde sich also auf den **regulären Ablauf auf der Suche nach Abwechslung** fokussiert. Es wurde gezeigt, wie Bina nach Feierabend durch die Fitness App nach einem geeigneten Sport-Angebot für sich sucht und **direkt auf ein neues Video hingewiesen wird**, dass ihren persönlichen Präferenzen entspricht. Ein neues Video direkt mit dem Start der App anzuzeigen entspricht dabei der Erkenntnis aus den User Interviews, das die Nutzer:innen der App nicht lange nach neuen Angeboten suchen, sondern stattdessen lieber bereits bekannte erneut machen, obwohl sie eigentlich Lust auf andere Workouts hätten. Im Storyboard wird weiter gezeigt, wie Bina das angebotene Training absolviert und anschließend die **Möglichkeit der Bewertung des Trainings** nutzt, bevor es in den Feierabend auf die Couch geht.
